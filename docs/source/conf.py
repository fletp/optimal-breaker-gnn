...
# optimal_breaker_gnn documentation build
...
from optimal_breaker_gnn import __version__ as release

# -- Project information -----------------------------------------------------

project = "optimal_breaker_gnn"
author = "Kedro"
...
htmlhelp_basename = "optimal_breaker_gnndoc"
...
latex_documents = [
    (
        master_doc,
        "optimal_breaker_gnn.tex",
        "optimal_breaker_gnn Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "optimal_breaker_gnn",
        "Project optimal_breaker_gnn codebase.",
        "Data-Science",
    )
]
